...
<div class="col-sm-5">
    <h1 class="m-0" style="color: #337AB7 ;">Add Client</h1>
</div><!-- /.col -->
<div class="col-sm-6">
...
<div class="form-wrap">
    <form action="{{route('admin.saveclientproject')}}" method="POST" enctype="multipart/form-data">
        @routes
        @csrf
        @if($errors->any())
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" id="ordering" name="ordering" class="form-control" placeholder="Enter Ordering">
                    </div>
                </div>
