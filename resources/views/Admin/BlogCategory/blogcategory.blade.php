...
<div class="col-sm-5">
    <h1 class="m-0" style="color: #337AB7 ;">Add Blog Category</h1>
</div><!-- /.col -->
<div class="col-sm-6">
...
<div class="form-wrap">
    <form action="{{route('admin.saveblogcategory')}}" method="POST" enctype="multipart/form-data">
        @routes
        @csrf
        @if($errors->any())
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="category" name="category" class="form-control col-6" placeholder="Enter Category">
                    </div>
                </div>
