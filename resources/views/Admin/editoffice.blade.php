...
<div class="col-sm-5">
    <h1 class="m-0" style="color: #337AB7 ;">Edit Office Video</h1>
</div><!-- /.col -->
<div class="col-sm-6">
...
<div class="form-wrap">
  <form action="{{route('admin.updateoffice')}}" method="POST" enctype="multipart/form-data">
    @csrf
    @routes
    @if($errors->any())
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="form-group col-lg-6">
            ...
            <input type="text" id="video" name="video" class="form-control" placeholder="Enter VideoLink" value="{{$data->video}}">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label class="control-label mb-3" for="feature"><b>Image</b></label>
            <img height="100px" width="100px" src="{{url(Storage::url($data->thumbnail))}}" alt="">
            <input type="file" id="thumbnail" name="thumbnail" class="form-control-file my-2" placeholder="Enter Image">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group col-lg-6">
