...
<div class="col-sm-5">
    <h1 class="m-0" style="color: #337AB7 ;"> Office Video</h1>
</div><!-- /.col -->
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item">
            <form action="{{route('admin.officevideo')}}" method="GET">
                <div>
                    <input type="submit" value="Add Office Video" style="background: #337AB7 !important;
...

        {
            ...
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: route('admin.deleteoffice', id),
                        data: {
                            _token: CSRF_TOKEN
                        },
                        dataType: 'JSON',
    ...
    <script>
        $(document).ready(function() {
            var datatable = $("#example3").DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: route('admin.showofficevideo'),
