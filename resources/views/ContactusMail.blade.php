...
<body>
<h3>Hello Admin,</h3>
<h3>New Feedback received from Website Using Contact us.
<h3>Name : {{$contact['name']}}</b></h3>
<h3>Email ID : <b>{{$contact['email']}}</b></h3>

<h3>PhoneNumber : <b>{{$contact['phone']}}</b></h3>
<h3>Feedback : <b>{{$contact['message']}}</b></h3>
<p><b>Thanks</b></p>
